...
BOOST_AUTO_TEST_CASE(test_absx_instructions)
{
	...
	M6502TestCase tests[]{
		...
		M6502TestCase("c---z", 0xbc, 0x34, 0x12, 0x70, 0x10, 0x33, 0x00, "LDY $1234, X", 4, 0x70, 0x10, 0x33, 0x70, "c----"),
		M6502TestCase("c----", 0xbc, 0x34, 0x12, 0x00, 0x10, 0xE0, 0x00, "LDY $1234, X", 5, 0x00, 0x10, 0xE0, 0x00, "c---z"),
		M6502TestCase("----z", 0xbc, 0x34, 0x12, 0x80, 0x10, 0x33, 0x00, "LDY $1234, X", 4, 0x80, 0x10, 0x33, 0x80, "-n---"),
		M6502TestCase("c---z", 0xbd, 0x34, 0x12, 0x70, 0x10, 0x33, 0x00, "LDA $1234, X", 4, 0x70, 0x70, 0x33, 0x00, "c----"),
		M6502TestCase("c----", 0xbd, 0x34, 0x12, 0x00, 0x10, 0xE0, 0x00, "LDA $1234, X", 5, 0x00, 0x00, 0xE0, 0x00, "c---z"),
		M6502TestCase("----z", 0xbd, 0x34, 0x12, 0x80, 0x10, 0x33, 0x00, "LDA $1234, X", 4, 0x80, 0x80, 0x33, 0x00, "-n---"),

		M6502TestCase("-----", 0xdd, 0x34, 0x12, 0x16, 0x75, 0x11, 0x10, "CMP $1234, X", 4, 0x16, 0x75, 0x11, 0x10, "c----"),
		M6502TestCase("-----", 0xdd, 0x34, 0x12, 0x75, 0x75, 0x11, 0x10, "CMP $1234, X", 4, 0x75, 0x75, 0x11, 0x10, "c---z"),
		M6502TestCase("-----", 0xdd, 0x34, 0x12, 0x15, 0xe5, 0xe0, 0x10, "CMP $1234, X", 5, 0x15, 0xe5, 0xe0, 0x10, "c-n--")
	};
...
BOOST_AUTO_TEST_CASE(test_absy_instructions)
{
	...
	M6502TestCase tests[]{
		...
		M6502TestCase("c---z", 0xb9, 0x34, 0x12, 0x70, 0x10, 0x22, 0x33, "LDA $1234, Y", 4, 0x70, 0x70, 0x22, 0x33, "c----"),
		M6502TestCase("c----", 0xb9, 0x34, 0x12, 0x00, 0x10, 0x22, 0xE0, "LDA $1234, Y", 5, 0x00, 0x00, 0x22, 0xE0, "c---z"),
		M6502TestCase("----z", 0xb9, 0x34, 0x12, 0x80, 0x10, 0x22, 0x33, "LDA $1234, Y", 4, 0x80, 0x80, 0x22, 0x33, "-n---"),

		M6502TestCase("-----", 0xd9, 0x34, 0x12, 0x16, 0x75, 0x11, 0x10, "CMP $1234, Y", 4, 0x16, 0x75, 0x11, 0x10, "c----"),
		M6502TestCase("-----", 0xd9, 0x34, 0x12, 0x75, 0x75, 0x11, 0x10, "CMP $1234, Y", 4, 0x75, 0x75, 0x11, 0x10, "c---z"),
		M6502TestCase("-----", 0xd9, 0x34, 0x12, 0x15, 0xe5, 0x11, 0xe0, "CMP $1234, Y", 5, 0x15, 0xe5, 0x11, 0xe0, "c-n--")
...
BOOST_AUTO_TEST_CASE(test_abs_instructions)
{
	...
	M6502TestCase tests[]{
		...
		M6502TestCase("-----", 0xcc, 0x34, 0x12, 0x16, 0x10, 0x11, 0x75, "CPY $1234", 4, 0x16, 0x10, 0x11, 0x75, "c----"),
		M6502TestCase("-----", 0xcc, 0x34, 0x12, 0x75, 0x10, 0x11, 0x75, "CPY $1234", 4, 0x75, 0x10, 0x11, 0x75, "c---z"),
		M6502TestCase("-----", 0xcc, 0x34, 0x12, 0x15, 0x10, 0x11, 0xe5, "CPY $1234", 4, 0x15, 0x10, 0x11, 0xe5, "c-n--"),

		M6502TestCase("c----", 0xed, 0x34, 0x12, 0x15, 0x25, 0x11, 0xe5, "SBC $1234", 4, 0x15, 0x10, 0x11, 0xe5, "c----")
	};
...
BOOST_AUTO_TEST_CASE(test_zpagex_instructions)
{
	...
	M6502TestCase tests[]{
		...
		M6502TestCase("c---z", 0xb5, 0x34, 0x12, 0x70, 0x10, 0x22, 0x33, "LDA $34, X", 4, 0x70, 0x70, 0x22, 0x33, "c----"),
		M6502TestCase("----z", 0xb5, 0x34, 0x12, 0x00, 0x10, 0x22, 0x33, "LDA $34, X", 4, 0x00, 0x00, 0x22, 0x33, "----z"),
		M6502TestCase("----z", 0xb5, 0x34, 0x12, 0x90, 0x10, 0x22, 0x33, "LDA $34, X", 4, 0x90, 0x90, 0x22, 0x33, "-n---")
	};
...
BOOST_AUTO_TEST_CASE(test_zpage_instructions)
{
	M6502TestCase zeroPageTests[] {
		...
		//flags, opcode, zval, A, desc, cycles, AOut, flagsOut
		M6502TestCase("----z", 0xe5, 0x05, 0x11, "SBC $10", 3, 0x11 - 0x05 - 0x01, "c----"),
		// two positives to a negative .. which is correct
		M6502TestCase("c---z", 0xe5, 0x20, 0x10, "SBC $10", 3, 0xF0, "-----"),
		// two negatives overflow to a positive
		M6502TestCase("c---z", 0xe5, 0x01, 0x80, "SBC $10", 3, 0x7F, "c--v-"),
		M6502TestCase("c---z", 0xe5, 0x90, 0x90, "SBC $10", 3, 0x00, "c---z"),

		// Decimal mode
		M6502TestCase("cd--z", 0xe5, 0x14, 0x85, "SBC $10", 3, 0x71, "cd-v-"),
		M6502TestCase("cd--z", 0xe5, 0x84, 0x85, "SBC $10", 3, 0x01, "cd---"),
		M6502TestCase("-d--z", 0xe5, 0x12, 0x85, "SBC $10", 3, 0x72, "cd-v-"),

		M6502TestCase("-----", 0xc5, 0x16, 0x75, "CMP $10", 3, 0x75, "c----"),
		M6502TestCase("-----", 0xc5, 0x75, 0x75, "CMP $10", 3, 0x75, "c---z"),
		M6502TestCase("-----", 0xc5, 0x15, 0xE5, "CMP $10", 3, 0xE5, "c-n--")
	};
...
BOOST_AUTO_TEST_CASE(test_extended_zpage_instructions)
{
	...
	M6502TestCase tests[]{
		...
		M6502TestCase("cn--z", 0xc6, 0x10, 0x14,      0x15,   0x10, 0x02, 0x33, "DEC $10", 5,      0x10, 0x02, 0x33, "c----"),
		M6502TestCase("c---z", 0xc6, 0x10, 0xFF,      0x00,   0x10, 0x02, 0x33, "DEC $10", 5,      0x10, 0x02, 0x33, "cn---"),
		M6502TestCase("-n---", 0xc6, 0x10, 0x00,      0x01,   0x10, 0x02, 0x33, "DEC $10", 5,      0x10, 0x02, 0x33, "----z"),
		M6502TestCase("cn--z", 0xe6, 0x10, 0x16,      0x15,   0x10, 0x02, 0x33, "INC $10", 5,      0x10, 0x02, 0x33, "c----"),
		M6502TestCase("c---z", 0xe6, 0x10, 0xFF,      0xFE,   0x10, 0x02, 0x33, "INC $10", 5,      0x10, 0x02, 0x33, "cn---"),
		M6502TestCase("-n---", 0xe6, 0x10, 0x00,      0xFF,   0x10, 0x02, 0x33, "INC $10", 5,      0x10, 0x02, 0x33, "----z")
	};
...
BOOST_AUTO_TEST_CASE(test_imm_instructions)
{
	M6502TestCase tests[]{
		...
		M6502TestCase("c---z", 0xe9, 0x15, 0x25, "SBC #15", 2, 0x10, "c----"),
		...
		M6502TestCase("-----", 0xC9,   0x16, 0x00, 0x00, 0x75, 0x44, 0x55, "CMP #16", 2,      0x75, 0x44, 0x55, "c----"),
		M6502TestCase("-----", 0xC9,   0x75, 0x00, 0x00, 0x75, 0x44, 0x55, "CMP #75", 2,      0x75, 0x44, 0x55, "c---z"),
		M6502TestCase("-----", 0xC9,   0x15, 0x00, 0x00, 0xe5, 0x44, 0x55, "CMP #15", 2,      0xe5, 0x44, 0x55, "c-n--"),
		M6502TestCase("-----", 0xe0,   0x16, 0x00, 0x00, 0x01, 0x75, 0x55, "CPX #16", 2,      0x01, 0x75, 0x55, "c----"),
		M6502TestCase("-----", 0xe0,   0x75, 0x00, 0x00, 0x01, 0x75, 0x55, "CPX #75", 2,      0x01, 0x75, 0x55, "c---z"),
		M6502TestCase("-----", 0xe0,   0x15, 0x00, 0x00, 0x01, 0xe5, 0x55, "CPX #15", 2,      0x01, 0xe5, 0x55, "c-n--")
	};
